...
/** Prod-like: same patterns with stricter timeouts and explicit env overrides */
export const prodLike: FrameworkConfig = {
  name: 'prod-like',
  modules: {
    'open-meteo': {
    ...
    fred: {
      baseURL: process.env.FRED_BASE_URL ?? 'https://api.stlouisfed.org',
      auth: { type: 'none' },
      timeoutMs: 25_000,
    },
    sec: {
